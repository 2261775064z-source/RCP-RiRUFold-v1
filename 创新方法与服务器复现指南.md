...
> 版本说明（2026-09-14）：本文档保留早期研究过程。当前权威的两研究点定义、公式、代码名和服务器消融矩阵统一以 `RCP两个研究点_公式代码实验对照.md` 为准；本文后文若仍出现旧符号 `U_B`、`anchor` 或带尺度偏置的权重公式，均已被新合同替代。

本文档记录新方法的完整早期推演。它同时回答四个问题：两篇根源论文如何融合、创新
